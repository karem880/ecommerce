...
<div className="overflow-scroll h-[90vh] rounded-lg border border-gray-200 shadow-md m-5">
  <table className="w-full border-collapse bg-white text-left text-sm h-[90vh] overflow-scroll text-gray-500">
    <thead className="bg-gray-50">
      <tr>
        ...
        <th scope="col" className="px-6 py-4 font-medium text-gray-900">count</th>
      ...
      <>
        ...
        <th className="flex gap-3 px-6 py-4 font-normal text-gray-900">
          <div className="relative h-10 w-10">
            <img className="h-full w-full rounded-full object-cover object-center" src={product.image} alt />
        ...
        <td className="px-6 py-4">
          ...
          <a  onClick={() => handleDelete(product.id)} href="#">
