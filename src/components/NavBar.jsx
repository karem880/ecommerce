      ...
      <nav className="bg-gray-800">
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <div className="hidden sm:ml-6 sm:block">
                <div className="flex space-x-4">
                  <NavLink to={'/login'} className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</NavLink>
            ...
            <div className="absolute inset-y-0 right-0 flex justify-center gap-3 w-[25%] items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              <div  onClick={handleimgaeMenuToggle} className="relative ml-3">
                ...
                {isimageactive ? (<> <div className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" >
                  <Link to={'/login'} className="block px-4 py-2 text-sm text-gray-700" role="menuitem" >Your Profile</Link>
                  <Link to={'/login'} className="block px-4 py-2 text-sm text-gray-700" role="menuitem" >Settings</Link>
                  <Link to={'/login'} className="block px-4 py-2 text-sm text-gray-700" role="menuitem" >Sign out</Link>
        ...
        <div className={`sm:hidden ${isMobileMenuOpen ? '' : 'hidden'}`} id="mobile-menu">
          <div className="space-y-1 px-2 pb-3 pt-2 flex flex-col items-center justify-center gap-1">
            ...
            <NavLink to={'/login'} className="bg-gray-900 text-white  rounded-md px-3 py-2 text-base font-medium w-full h-[50px] flex items-center" aria-current="page">Home</NavLink>
            <NavLink to={'/login'} className="text-gray-300 hover:bg-gray-700 w-full  flex items-center h-[50px] hover:text-white  rounded-md px-3 py-2 text-base font-medium">category</NavLink>
            <NavLink to={'/login'} className="text-gray-300 hover:bg-gray-700 w-full  flex items-center h-[50px] hover:text-white  rounded-md px-3 py-2 text-base font-medium">Products</NavLink>
            <NavLink to={'/login'} className="text-gray-300 hover:bg-gray-700 w-full  flex items-center h-[50px] hover:text-white  rounded-md px-3 py-2 text-base font-medium">review</NavLink>
